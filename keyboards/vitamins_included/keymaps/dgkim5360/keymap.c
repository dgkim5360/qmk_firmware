...
[SYM] = LAYOUT_ortho_4x12(
     KC_LPRN, KC_EXLM, KC_AT,   KC_HASH, KC_RPRN,XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
     KC_LBRC, KC_DLR,  KC_PERC, KC_CIRC, KC_RBRC,XXXXXXX,  XXXXXXX,  XXXXXXX, KC_RSFT, KC_RGUI, KC_LALT, _______,
     KC_BSLS, KC_AMPR, KC_ASTR, KC_MINS, KC_EQL, _______,  _______,  XXXXXXX, XXXXXXX, _______, _______, _______,
