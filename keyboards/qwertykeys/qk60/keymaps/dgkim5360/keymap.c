...
[0] = LAYOUT_hot(
	...
	SC_LSPO, KC_Z,           KC_X,    KC_C,   KC_V,     KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SC_RSPC, TO(2),

	XXXXXXX, TO(0), KC_LCTL, KC_LALT,  LT(3, KC_SPC),  XXXXXXX,  LT(4, KC_SPC),  KC_RALT, KC_RCTL, TO(1), XXXXXXX
),
...
[1] = LAYOUT_hot(
	...
	_______, _______, KC_LGUI, _______,          _______, _______, _______,          _______, _______, _______, _______
),
...
[2] = LAYOUT_hot(
	...
	KC_LCTL, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
	_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 
	_______, _______, KC_LGUI, _______,          KC_SPC,  _______, KC_SPC,           _______, _______, _______, _______
),
...
[3] = LAYOUT_hot(
	...
	_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 
	_______, _______, _______, _______,          _______, _______, KC_KB_VOLUME_UP,  _______, _______, _______, _______
),
...
[4] = LAYOUT_hot(
	...
	_______, _______, _______, _______, KC_KB_VOLUME_DOWN,_______, _______,          _______, _______, _______, _______
)
};
